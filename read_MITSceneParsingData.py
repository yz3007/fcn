...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 15:06:10 2019
...
def create_image_lists(image_dir):
    ...
    for directory in directories:
        ...
        file_list.extend(glob.glob(file_glob))  # list of full paths about original images, read later
        ...
        random.shuffle(image_list[directory])  # shuffle !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
